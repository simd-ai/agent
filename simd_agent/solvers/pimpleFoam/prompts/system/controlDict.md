...
- If using adaptive time stepping: add `adjustTimeStep yes; maxCo 0.5;`
- `maxCo 0.5` is the safe default — at 0.9, one bad cell can push CFL > 1 and cause instability
