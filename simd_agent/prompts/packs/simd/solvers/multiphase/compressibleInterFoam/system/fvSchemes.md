# compressibleInterFoam — system/fvSchemes

## Algorithm context (from source)
The main loop is: **alphaEqnSubCycle → turbulence.correctPhasePhi() → UEqn → TEqn (or EEqn) → pEqn → turbulence.correct()**

This means ALL of these div terms will be looked up at runtime:
