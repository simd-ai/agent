...
class TestRealCodegen:
    """Tests for real AI code generation without simulation execution."""
    ...
    async def test_pipe_flow_generation(self, mock_websocket, mock_store, output_dir):
        ...
        4. Save output for inspection (NOT submitted to simulation server)
        """
        ...
        print("   ℹ️  The case.zip can be submitted to the simulation server for testing")
